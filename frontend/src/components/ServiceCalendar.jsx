...
const shell = {
  ...
  card: { background: 'rgba(255,255,255,0.72)', border: '1px solid transparent', borderRadius: '16px', boxShadow: 'var(--shadow-soft)', overflow: 'hidden' },
  ...
  dayBtn: { border: '1px solid transparent', borderRadius: '10px', background: 'rgba(255,255,255,0.7)', minHeight: '76px', padding: '7px', textAlign: 'left', cursor: 'pointer', display: 'flex', flexDirection: 'column', gap: '4px' },
  ...
  selectedCard: { border: '1px solid transparent', borderRadius: '12px', background: 'rgba(255,255,255,0.74)', overflow: 'hidden' },
  ...
  selectedBody: { padding: '10px 12px', display: 'grid', gap: '10px', background: 'rgba(255,255,255,0.22)' },
  eventGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(210px, 1fr))', gap: '10px' },
  eventCard: { border: '1px solid transparent', borderRadius: '12px', padding: '11px 11px 10px', background: 'linear-gradient(180deg, rgba(248,250,252,0.84) 0%, rgba(255,255,255,0.72) 100%)', display: 'grid', gap: '7px', minWidth: 0 },
  ...
  eventPill: { display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '5px 8px', borderRadius: '999px', background: 'rgba(248,250,252,0.7)', color: '#334155', fontSize: '11px', fontWeight: 700, lineHeight: 1.2 },
