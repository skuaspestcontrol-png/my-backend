...
const shell = {
  ...
  steps: { display: 'grid', gridTemplateColumns: 'repeat(5, minmax(0, 1fr))', gap: '6px', padding: '10px 12px', borderBottom: '1px solid rgba(148, 163, 184, 0.18)', background: 'linear-gradient(180deg, rgba(255,255,255,0.99) 0%, rgba(250,250,252,0.98) 100%)' },
  step: { minHeight: '40px', border: '1px solid rgba(148, 163, 184, 0.16)', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', fontSize: '12px', fontWeight: 850, color: '#475569', background: 'linear-gradient(180deg, rgba(255,255,255,0.99) 0%, rgba(248,250,252,0.98) 100%)' },
  body: { overflow: 'auto', padding: '12px', background: 'linear-gradient(180deg, rgba(248,250,252,0.96) 0%, rgba(243,244,246,0.94) 100%)', display: 'grid', gap: '10px' },
  panel: { background: 'linear-gradient(180deg, rgba(255,255,255,0.99) 0%, rgba(249,250,252,0.98) 100%)', border: '1px solid rgba(148, 163, 184, 0.16)', borderRadius: '12px', padding: '12px', display: 'grid', gap: '10px', boxShadow: '0 10px 24px rgba(15, 23, 42, 0.05)', backgroundClip: 'padding-box' },
  ...
  card: { background: 'linear-gradient(180deg, rgba(255,255,255,0.99) 0%, rgba(249,250,252,0.98) 100%)', border: '1px solid rgba(148, 163, 184, 0.16)', borderRadius: '10px', padding: '9px', boxShadow: '0 8px 20px rgba(15, 23, 42, 0.04)', backgroundClip: 'padding-box' },
  ...
  tableWrap: { overflowX: 'auto', border: '1px solid rgba(148, 163, 184, 0.18)', borderRadius: '12px', background: 'linear-gradient(180deg, rgba(255,255,255,0.99) 0%, rgba(250,250,252,0.98) 100%)', boxShadow: '0 10px 24px rgba(15, 23, 42, 0.05)', backgroundClip: 'padding-box' },
  ...
  footer: { borderTop: '1px solid rgba(148, 163, 184, 0.18)', padding: '10px 12px', background: 'linear-gradient(180deg, rgba(255,255,255,0.97), rgba(248,250,252,0.99))', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '8px', flexWrap: 'wrap', backdropFilter: 'blur(10px)' },
