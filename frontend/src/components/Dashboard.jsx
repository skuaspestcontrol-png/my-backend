...
const shell = {
  ...
  sourceHeaderBadge: { color: '#111827', fontWeight: 700, background: '#f1f5f9', borderRadius: '10px', padding: '4px 8px', fontSize: '11px', lineHeight: 1.1, boxShadow: 'inset 0 0 0 1px rgba(148,163,184,0.10)' },
  sourceHeaderSelect: { color: '#111827', fontWeight: 700, background: '#f1f5f9', borderRadius: '10px', padding: '4px 8px', fontSize: '11px', lineHeight: 1.1, boxShadow: 'inset 0 0 0 1px rgba(148,163,184,0.10)', border: 'none', outline: 'none', appearance: 'none' },
