...
const s = {
  ...
  hd: { minHeight: '56px', boxSizing: 'border-box', background: 'linear-gradient(135deg, var(--color-primary-deep), var(--color-primary))', padding: '0 22px', color: '#fff', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '24px', lineHeight: 1.2, fontWeight: 800, letterSpacing: 0, borderBottom: '1px solid transparent' },
