...
export default function DashboardStatCard({ title, value, icon, tone = 'var(--color-primary)', style, contentStyle, titleStyle, valueStyle }) {
  return (
    <AppCard style={{ padding: 0, ...style }}>
