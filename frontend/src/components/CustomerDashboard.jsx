...
const shell = {
  ...
  menu: { position: 'absolute', right: 0, top: '38px', background: '#fff', border: '1px solid var(--brand-border-color)', borderRadius: '8px', width: '188px', boxShadow: '0 12px 28px rgba(15,23,42,0.12)', zIndex: 20, overflow: 'hidden', padding: '3px 0' },
