...
const shell = {
  ...
  historySection: { border: '1px solid var(--color-border)', borderRadius: '12px', background: '#fff', overflow: 'hidden', boxShadow: '0 10px 24px rgba(15,23,42,0.05)' },
...
export default function CustomerDashboard() {
  ...
  const normalizeIncomingCustomerPrefill = (prefill = {}) => {
    ...
    return {
      ...
      whatsappNumber,
      altNumber,
      billingSearchAddress: String(next.billingSearchAddress || next.searchAddress || '').trim(),
      ...
      shippingSearchAddress: String(next.shippingSearchAddress || '').trim(),
  ...
  const mapCustomerToForm = (customer) => {
    ...
    return {
      ...
      billingSearchAddress: customer.billingSearchAddress || customer.searchAddress || '',
      ...
      shippingSearchAddress: customer.shippingSearchAddress || '',
