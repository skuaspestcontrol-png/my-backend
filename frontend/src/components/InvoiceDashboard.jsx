...
const shell = {
  ...
  modal: { background: 'rgba(255,255,255,0.9)', width: 'min(100%, 1180px)', borderRadius: '24px', border: '1px solid rgba(159, 23, 77, 0.24)', boxShadow: 'var(--shadow)', overflow: 'hidden', maxHeight: '92vh', height: '92vh', display: 'flex', flexDirection: 'column' },
  ...
  addressPicker: { background: 'rgba(255,255,255,0.9)', width: 'min(100%, 720px)', borderRadius: '20px', border: '1px solid rgba(159, 23, 77, 0.24)', boxShadow: 'var(--shadow)', overflow: 'hidden' },
  ...
  miniModal: { width: 'min(100%, 680px)', background: 'rgba(255,255,255,0.9)', borderRadius: '20px', border: '1px solid rgba(159, 23, 77, 0.24)', boxShadow: 'var(--shadow)', overflow: 'hidden' },
          ...
          <form style={modalStyle} onSubmit={handleSubmit} onClick={(event) => event.stopPropagation()}>
            ...
            <div style={shell.formBody}>
              ...
              <div style={topGridStyle}>
                ...
                <input
                  type="date"
                  style={{ ...shell.input, textAlign: 'left' }}
                  value={form.dueDate}
